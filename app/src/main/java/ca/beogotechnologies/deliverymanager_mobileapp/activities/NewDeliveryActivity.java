...
public class NewDeliveryActivity extends AppCompatActivity implements ClientsTask.AsyncResponse, NewDeliveryTask.AsyncResponse {
    ...
    private void initViews() {
        ...
        mReceiver = (EditText) findViewById(R.id.txtReceiver);
    ...
    public void saveNewDelivery(View view) {
        ...
        if (validData(sendDate, client, receiver, receiverAddress, senderReferences, senderComments))
        {
            ...
            if (!userSessionId.isEmpty() && (!sendDate.isEmpty() && !client.isEmpty() && !receiver.isEmpty()))
            {
                ...
                task.execute(userSessionId, userId, client, sendDate, receiver, receiverAddress, senderReferences, senderComments);
            }
        }
    ...
    private boolean validData(String sendDate, String client, String receiver, String receiverAddress, String senderReferences, String senderComments) {
        ...
        {
            mReceiver.setError("Ne peut pas etre vide");
            isValid = false;
        }
    ...
    public void processFinish(String result) {
        if (result != null && !result.isEmpty())
        {
            ...
            {
                //Toast
                Toast.makeText(getApplicationContext(), "Nouvelle livraison bien cree", Toast.LENGTH_SHORT).show();
        ...
        {
            //Toast
            Toast.makeText(getApplicationContext(), "Probleme survenue lors de la creation de la livraison", Toast.LENGTH_LONG).show();
        }
