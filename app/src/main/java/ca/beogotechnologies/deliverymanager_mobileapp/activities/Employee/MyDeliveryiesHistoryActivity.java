...
public class MyDeliveryiesHistoryActivity extends AppCompatActivity implements DeliveriesTask.AsyncResponse {
    ...
    private void populateDeliveries(String result) {
        try
        {
            ...
            {
                Toast.makeText(getApplicationContext(), "Pas d'historique de livraison encore", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void initListView() {
        ...
        mDeliveries.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), MyDeliveryHistoryDetailsActivity.class);
