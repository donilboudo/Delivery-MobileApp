...
public class MyOpenedDeliveriesActivity extends AppCompatActivity implements MyDeliveriesTask.AsyncResponse {
    ...
    private void initListView() {
        ...
        mDeliveries.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), CompleteDeliveryActivity.class);
