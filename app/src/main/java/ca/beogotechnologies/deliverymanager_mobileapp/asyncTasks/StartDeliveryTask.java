...
public class StartDeliveryTask extends AsyncTask<String, Void, String> {
    private static final String loginEndpointUrl = EndpointConstants.remoteEndpointUrl + "/mobile/startDelivery";
    ...
    public StartDeliveryTask(AsyncResponse delegate) {
    ...
    protected String doInBackground(String... args) {
        try
        {
            ...
            postDataParams.put("sendDate", args[2]);
            postDataParams.put("senderComments", args[3]);
            postDataParams.put("senderReferences", args[4]);
            postDataParams.put("receiverName", args[5]);
            postDataParams.put("receiverAddress", args[6]);
            postDataParams.put("receiverNumber", args[7]);
