...
public class AssignDeliveryRequestTask extends AsyncTask<String, Void, String> {
    private static final String loginEndpointUrl = EndpointConstants.remoteEndpointUrl + "/mobile/assignDeliveryRequest";
    ...
    public AssignDeliveryRequestTask(AsyncResponse delegate) {
    ...
    protected String doInBackground(String... args) {
        try
        {
            ...
            postDataParams.put("requestId", args[1]);
            postDataParams.put("deliverId", args[2]);
