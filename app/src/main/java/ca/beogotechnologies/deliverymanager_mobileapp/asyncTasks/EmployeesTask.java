...
public class EmployeesTask extends AsyncTask<String, Void, String> {
    private static final String clientEndpointUrl = EndpointConstants.remoteEndpointUrl + "/mobile/employees";

    public interface AsyncResponse {
        void getEmployeesProcessFinish(String output);
    }

    private AsyncResponse delegate = null;

    public EmployeesTask(AsyncResponse delegate) {
    ...
    protected void onPostExecute(String result) {
        delegate.getEmployeesProcessFinish(result);
    }
}